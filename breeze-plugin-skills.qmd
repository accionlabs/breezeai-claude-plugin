...
This document defines 7 skills for the Breeze MCP Claude Code plugin.
...
└── skills/
    ├── init/
    │   └── SKILL.md                         ← Skill 1: Initialize Breeze
    ├── search/
    │   └── SKILL.md                         ← Skill 2: Search Graph
    ├── update-graph/
    │   ├── SKILL.md                         ← Skill 3: Update Functional Graph
    │   └── func-prompt-rules.md             ← Supporting file: generation rules
    ├── requirements/
    │   └── SKILL.md                         ← Skill 4: Requirement Analysis
    ├── design/
    │   └── SKILL.md                         ← Skill 5: Design Analysis
    ├── architecture/
    │   └── SKILL.md                         ← Skill 6: Architecture Analysis
    └── codegen/
        └── SKILL.md                         ← Skill 7: Code & Test Generation
```
...
| `skills/update-graph/func-prompt-rules.md` | Persona/Outcome/Scenario generation rules (referenced by SKILL.md) |
...
| `Code_Graph_Search` | search, codegen |
| `Documents` | requirements, design, architecture |
...
> **Invoked as:** `/breeze:codegen <feature or scenario>`
